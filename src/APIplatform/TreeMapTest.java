...
public class TreeMapTest {
    ...
    public static void main(String[] agrs){
        ...
        System.out.println("key=jiaboyan:"+getValue+" "+" firstKey:"+firstKey+" lastKey:"+lastKey+" lowerKey lower than jiaboyan:"
        +lowerKey+" ceilingKey bigger than jiaboyan:"+ceilingKey+" sortedMap from a to jiaboyan"+sortedMap);

        //删除元素：
        Integer removeValue = treeMap.remove("jiaboyan");//删除集合中key为"jiaboyan"的元素
        System.out.println("remove value后的返回值是什么？"+removeValue);
        boolean isContain = treeMap.containsKey("jiaboyan");//判断集合的key中是否包含"jiaboyan"
        System.out.println("jiaboyan有吗？"+isContain);
        boolean isEmpty = treeMap.isEmpty();
        System.out.println("空吗？"+isEmpty);
        treeMap.clear(); //清空集合元素：
        //判断方法：
        isEmpty = treeMap.isEmpty();//判断集合是否为空
        System.out.println("清空之后，空吗？"+isEmpty);
